...
- **Rich Content** — Support for markdown, LaTeX math equations, and syntax-highlighted code blocks.

## Rich Content Rendering

Presentations can include markdown, LaTeX math equations, and syntax-highlighted code blocks using CDN libraries.

### Features

- **Markdown** — Full CommonMark support including headings, lists, blockquotes, tables, and links
- **LaTeX Math** — Inline `$...$` and block `$$...$$` equation rendering via KaTeX
- **Syntax Highlighting** — 15+ languages including JavaScript, TypeScript, Python, Go, Rust, SQL, and more

### Usage

1. Include the required CDN libraries in your HTML `<head>` (see `html-template.md` for the complete list)
2. Add a `.markdown-content` class to elements containing markdown text
3. The content is automatically parsed when the presentation loads
...
See `test-content-rendering.html` for a complete working example.

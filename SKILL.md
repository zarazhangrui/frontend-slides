...
- Use fonts from Google Fonts or Fontshare — never system fonts. **Note:** Fontshare fonts have broken PostScript metadata that causes PDF export issues (see Phase 6B Font Safety). Google Fonts are recommended when PDF export is likely.
